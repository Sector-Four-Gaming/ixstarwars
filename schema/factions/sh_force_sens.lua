...
FACTION.name = "Force-Sensitive"
FACTION.description = "Characters imbued with the knowledge and abilities of the Force."
FACTION.color = Color(50, 205, 50)
...
FACTION_FORCESENS = FACTION.index
